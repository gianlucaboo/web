...
//1.1. Mapbox base map settings (center, zoom, zoom control)
var ebola;	
var map = L.map('map', { 
...
//1.2. Mapbox base map request
L.tileLayer('https://a.tiles.mapbox.com/v3/giuzgeo454.kgng6i8j/{z}/{x}/{y}.png', {
attribution: '<a href="http://www.nature.com/articles/sdata201442#cite1"> Nature</a> '})
		.addTo(map)
		
//1.3. GeoJson request
$.getJSON("labs/geojson/ebola.json")    
		.done(function(data) {
